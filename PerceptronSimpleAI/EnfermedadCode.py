...
P = np.array([
    [-1, -1, -1],   # Sin fiebre, sin dolor, sin fatiga
    [-1, -1,  1],   # Fatiga
    [-1,  1, -1],   # Dolor
    [-1,  1,  1],   # Dolor + fatiga
    [ 1, -1, -1],   # Fiebre
...
# 2. INICIALIZACIÓN DE PESOS Y PARÁMETROS
...
fig.suptitle('Entrenamiento del Perceptrón Simple - Diagnóstico Médico', fontsize=15, fontweight='bold', color='#1E3A8A')
...
for i, y in enumerate(input_y):
    ...
    nombres = ['Fiebre', 'Dolor', 'Fatiga']
    ax2.text(input_x-0.1, y, nombres[i], fontsize=10, weight='bold', va='center')
...
ax2.text(output_x+0.05, output_y, 'Diagnóstico', fontsize=11, weight='bold', va='center')
...
print("\n============================================================")
print("RESULTADOS FINALES - PERCEPTRÓN MÉDICO")
print("============================================================")
